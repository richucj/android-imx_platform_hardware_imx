...
#ifndef CPP_EVS_NXP_AIDL_INCLUDE_EVSV4LCAMERA_H
#define CPP_EVS_NXP_AIDL_INCLUDE_EVSV4LCAMERA_H
...
private:
    ...
    unsigned queueBufferToCamera(buffer_handle_t &memHandle);
...
#endif  // CPP_EVS_NXP_AIDL_INCLUDE_EVSV4LCAMERA_H
